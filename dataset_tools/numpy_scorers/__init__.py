...
from dataset_tools.numpy_scorers.a1111_numpy_scorer import (
    A1111NumpyScorer,
...
from dataset_tools.numpy_scorers.comfyui_numpy_scorer import (
    ComfyUINumpyScorer,
    should_use_comfyui_numpy_scoring,
)
from dataset_tools.numpy_scorers.drawthings_numpy_scorer import (
